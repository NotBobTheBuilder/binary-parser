...
declare type ComplexTypes = 'bit' | 'string' | 'buffer' | 'array' | 'prefixed' | 'prefixedArray' | 'choice' | 'nest' | 'seek' | 'pointer' | 'saveOffset' | '';
...
export declare class Parser {
    ...
    seek(relOffset: number, options?: ParserOptions): this;
    ...
    prefixed(varName: string, options: ParserOptions): this;
    prefixedArray(varName: string, options: ParserOptions): this;
    ...
    getCompiledContext(): Context;
    getCompiledContextEncode(): Context;
    private addRawCode;
    ...
    private generatePrefixed;
    private generate_encodePrefixed;
    private generatePrefixedArray;
    private generate_encodePrefixedArray;
